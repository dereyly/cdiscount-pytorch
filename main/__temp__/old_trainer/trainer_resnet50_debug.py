...
def train_augment(image):
    image = fix_resize(image, 160,160)
...
def run_training():
    ...
    out_dir    = '/root/share/project/kaggle/cdiscount/results/resnet50-160_focal-loss-01' # s_xx1'
    initial_checkpoint = \
        None
    ...
    train_dataset = CDiscountDataset(#'train_id_v0_5655916', 'train',  mode='train',
                                     ...
                                     #'debug_train_id_v0_5000', 'train',  mode='train',  #'train_id_v0_100000',#
