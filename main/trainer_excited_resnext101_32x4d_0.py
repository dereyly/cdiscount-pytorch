...
def run_training():
    ...
    pretrained_file = '/root/share/project/kaggle/cdiscount/results/resnext101-180-00c/checkpoint/starter_model.pth'
    				 # '/home/ck/project/results/resnext101-00c/checkpoint/00048000_model.pth'  ##0.6147
