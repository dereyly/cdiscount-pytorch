...
from net.model.cdiscount.excited_dense_resnet50  import SEResNet50 as Net
...
def run_training():
    ...
    out_dir    = '/root/share/project/kaggle/cdiscount/results/dense-excited-resnet50-128-00a' # s_xx1'
    initial_checkpoint = \
        None
        #'/root/share/project/kaggle/cdiscount/results/resnet50-224-00/checkpoint/00026000_model.pth'
        #None

    pretrained_file = '/root/share/data/models/reference/senet/ruotianluo/SE-ResNet-50.convert.pth'
    ...
    batch_size  = 64   #512  #96 #256
    iter_accum  = 8    #448//batch_size
