...
#CUDA_DEVICE_ORDER
is_val =False
test_out = '/media/dereyly/data/tmp/result/test_11dec/'
out_dir='/media/dereyly/data/tmp/result/'
batch_size =256
workers=4
dir_im = '/home/dereyly/ImageDB/cdiscount/'
if is_val:
    bson_fname = '/media/dereyly/data/data/train.bson'
else:
    bson_fname = '/media/dereyly/data/data/test.bson'
...
model_path = '/media/dereyly/data/tmp/result/checkpoint/3_00000000_model.pth'
