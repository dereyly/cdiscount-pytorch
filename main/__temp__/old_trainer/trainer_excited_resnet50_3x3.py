...
from net.model.cdiscount.excited_resnet50_3x3  import SEResNet50_3x3 as Net
...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/excited-resnet50-3x3-03' # s_xx1'
    initial_checkpoint = \
        None #'/root/share/project/kaggle/cdiscount/results/excited-resnet50-3x3-01/checkpoint/00008000_model.pth'
        #
