...
def train_augment(image):
    ...
    # crop random ---------
    x0 = np.random.choice(320-299)
    y0 = np.random.choice(320-299)
    x1 = x0+299
    y1 = y0+299
...
def run_training():
    ...
    out_dir  = '/home/ck/project/results/inception3-180-02a' # s_xx1'
    initial_checkpoint = \
		None
        # '/home/ck/project/results/inception3-299-02a/checkpoint/00040000_model.pth'
        #None  #
