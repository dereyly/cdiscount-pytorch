...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/xception-180-03' # s_xx1'
    initial_checkpoint = \
        None  #'/root/share/project/kaggle/cdiscount/results/xception-180-01/checkpoint/00016000_model.pth'
        #


    pretrained_file = \
        '/root/share/project/kaggle/cdiscount/results/xception-240-00/checkpoint/00025000_model.pth'
