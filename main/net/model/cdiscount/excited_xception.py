...
class SBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, out_channels, reduction, is_first_relu=True):
        ...
        self.scale = SEScale(out_channels, reduction)
...
class XBlock(nn.Module):
    ...
    def __init__(self, in_channels, reduction):
        ...
        self.scale = SEScale(in_channels, reduction)
...
class SEXception(nn.Module):
    ...
    def __init__(self, in_shape=(3,128,128), num_classes=5000 ):
        super(SEXception, self).__init__()
        ...
        self.entry1  = SBlock( 64,128,128, 16, is_first_relu=False)
        self.entry2  = SBlock(128,256,256, 32)
        self.entry3  = SBlock(256,728,728, 64)

        self.middle1 = XBlock(728,64)
        self.middle2 = XBlock(728,64)
        self.middle3 = XBlock(728,64)
        self.middle4 = XBlock(728,64)
        self.middle5 = XBlock(728,64)
        self.middle6 = XBlock(728,64)
        self.middle7 = XBlock(728,64)
        self.middle8 = XBlock(728,64)

        self.exit1 = SBlock( 728, 728,1024,128)
...
def run_check_net():
    ...
    net = SEXception(in_shape=in_shape, num_classes=num_classes)
    net.load_pretrain_pytorch_file(
            '/root/share/project/kaggle/cdiscount/results/xception-180-01/checkpoint/00024000_model.pth',
