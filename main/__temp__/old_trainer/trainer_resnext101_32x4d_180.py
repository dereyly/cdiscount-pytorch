...
def run_training():
    ...
    out_dir    = '/home/ck/project/results/resnext101-180-00c' # s_xx1'
    initial_checkpoint = \
      '/home/ck/project/results/resnext101-180-00c/checkpoint/00079000_model.pth'
       #None  #
        

    #pretrained_file = '/root/share/data/models/reference/imagenet/resnext/resnext_101_32x4d.convert.pth'
    pretrained_file = '/home/ck/project/results/resnext101-180-00b/checkpoint/starter_model.pth'
