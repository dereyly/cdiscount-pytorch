...
#  Dilated Residual Networks - Fisher Yu and Vladlen Koltun and Thomas Funkhouser, cvpr 2017
...
class DRN(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000,
                 ...
                 out_map=False, out_middle=False, arch='D',in_shape=(3,224,224)):
...
def run_check_net():
    ...
    net = drn_d_54(in_shape=in_shape,num_classes=num_classes)
