...
input_train=''
ctg_fname='/home/dereyly/data_raw/ctg_dict_train.pkl'
data = bson.decode_file_iter(open('/home/dereyly/data_raw/train.bson', 'rb'))
fname_tr='/home/dereyly/data_raw/train_ctg.txt'
fname_tst='/home/dereyly/data_raw/val_ctg.txt'
f_tr=open(fname_tr,'w')
f_tst=open(fname_tst,'w')
prod_to_category = dict()

# category_statistic = dict()
cls_ctg_filter = pkl.load(open(ctg_fname, 'rb'))
# category_to_ind={}
...
for c, d in enumerate(data):
    ...
    if category_id not in cls_ctg_filter:
        continue
    ...
    for e, pic in enumerate(d['imgs']):
        ...
        str_out=str(product_id) + "_" + str(e) + ".png "+str(cls_ctg_filter[category_id])+'\n'
        if is_val:
            f_tst.write(str_out)
        else:
            f_tr.write(str_out)
