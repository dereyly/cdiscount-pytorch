...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/excited-resnet50-no-aug-00-rmsprop-x1' # s_xx1'
    initial_checkpoint = \
        None #'/root/share/project/kaggle/cdiscount/results/excited-resnet50-no-aug-00/checkpoint/00010000_model.pth'


    pretrained_file = \
        '/root/share/data/models/reference/senet/senet/SENet.convert.pth'
    skip = ['fc.']
