...
fname_imagenet='/home/dereyly/progs/caffe-master/data/ilsvrc12/train.txt'
dir_img='/home/dereyly/ImageDB/imagenet_150/train/'
dir_img_bson='/home/dereyly/ImageDB/cdiscount/train/'
data_tr=pkl.load(open(pkl_in,'rb'))
for i in range(len(data_tr)):
    # print(data_tr[i][0])
    data_tr[i]=(dir_img_bson+data_tr[i][0],data_tr[i][1])
print(len(data_tr))
