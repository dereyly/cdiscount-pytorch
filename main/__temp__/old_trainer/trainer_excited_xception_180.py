...
from net.model.cdiscount.excited_xception import SEXception as Net
...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/excited-xception-180-01a' # s_xx1'
    initial_checkpoint = \
        None  #'/root/share/project/kaggle/cdiscount/results/excited-xception-180-01/checkpoint/00008000_model.pth'
        #


    pretrained_file = \
        '/root/share/project/kaggle/cdiscount/results/excited-xception-180-01/checkpoint/00008000_model.pth'
