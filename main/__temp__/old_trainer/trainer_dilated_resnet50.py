...
def run_training():
    ...
    out_dir  = '/home/ck/project/results/drn-resnet50-00a' # s_xx1'
    initial_checkpoint = \
        '/home/ck/project/results/drn-resnet50-00/checkpoint/00012000_model.pth'
        #

    pretrained_file = '/home/ck/project/data/pretrain/drn_d_54-0e0534ff.pth'
    ...
    if initial_checkpoint is not None:
        ...
        start_iter  = 13000#checkpoint['iter' ]
        start_epoch = 0.42#checkpoint['epoch']
