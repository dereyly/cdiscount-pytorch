...
from net.model.cdiscount.inception_resnetv2  import InceptionResNetV2 as Net
...
def train_augment(image):
    if random.random() < 0.5:
        image = random_crop_scale(image, scale_limit=[1/1.3,1.3],u=1)
    else:
        pass
...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/inception-resenet-3x3-00' # s_xx1'
    initial_checkpoint = \
        None
