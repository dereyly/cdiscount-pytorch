...
def run_training():
    ...
    out_dir  = '/root/share/project/kaggle/cdiscount/results/modified-inception3_1-180-00' # s_xx1'
    initial_checkpoint = \
		'/root/share/project/kaggle/cdiscount/results/modified-inception3_1-180-00/checkpoint/00002000_model.pth'
        #None  #

    #pretrained_file = '/home/ck/project/data/pretrain/inception_v3_google-1a9a5a14.pth'
    pretrained_file = '/root/share/project/kaggle/cdiscount/results/excited-inception3_1-180-01a/checkpoint/00066000_model.pth'
    ...
    optimizer = optim.SGD(filter(lambda p: p.requires_grad, net.parameters()), lr=0.01, momentum=0.9, weight_decay=0.0001)
