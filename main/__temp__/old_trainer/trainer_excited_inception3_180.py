...
from net.model.cdiscount.excited_inception_v3_1 import SEInception3 as Net
...
def run_training():
    ...
    initial_checkpoint = \
        '/root/share/project/kaggle/cdiscount/results/excited-inception3_1-180-01/checkpoint/00060000_model.pth'
        #None  #'/home/ck/project/results/excited-inception3-180-02b/checkpoint/00020000_model.pth'

 
    pretrained_file = \
        None #'/root/share/project/kaggle/cdiscount/results/__submission__/stable-00/excited-inception3-180-02c/checkpoint/00051000_model.pth'
    ...
    iter_save   = [0, num_iters-1]\
                   ...
                   #+ list(range(0,num_iters,1*100))


    ## optimizer = optim.SGD(net.parameters(), lr=0.01, momentum=0.9, weight_decay=0.0005)  ###0.0005
    optimizer = optim.SGD(filter(lambda p: p.requires_grad, net.parameters()), lr=0.01, momentum=0.5, weight_decay=0.0001)
    ...
    if initial_checkpoint is not None:
        ...
        net.load_pretrain_pytorch_file( pretrained_file, skip, is_skip_se )
