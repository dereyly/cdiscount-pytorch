...
from net.model.cdiscount.senet  import SENet2048 as Net
...
def run_training():
    ...
    out_dir    = '/root/share/project/kaggle/cdiscount/results/excited-resnext101-180-00' # s_xx1'
    initial_checkpoint = \
       None  #'/home/ck/project/results/resnext101-180-00c/checkpoint/00079000_model.pth'
       #
        

    #pretrained_file = '/root/share/data/models/reference/imagenet/senet/SENet.convert.pth'
    pretrained_file = '/home/ck/project/data/pretrain/SENet.convert.pth'
