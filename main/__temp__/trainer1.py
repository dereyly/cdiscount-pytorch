...
def run_training():
    ...
    batch_size  = 1024   #512  #96 #256
    iter_accum  = 1024//batch_size
        ...
        for (images, labels, indices) in train_loader:
            ...
            if i in iter_valid:
                ...
                log.write('%0.4f  %5.1f k   %4.2f  | %0.4f  %0.4f | %0.4f  %0.4f | %0.4f  %0.4f | %5.0f min \n' % \
                        (rate, i//iter_accum/1000, epoch, valid_loss, valid_acc, train_loss, train_acc, batch_loss, batch_acc,
                          (timer() - start)/60))
            ...
            if i%iter_print == 0:
                print('\r%0.4f  %5.1f k   %4.2f  | ......  ...... | %0.4f  %0.4f | %0.4f  %0.4f | %5.0f min ' % \
                        (rate, i//iter_accum/1000, epoch, train_loss, train_acc, batch_loss, batch_acc,(timer() - start)/60),\
                        end='',flush=True)
